...
class OAIWUI_GPT_WebUI:
    def __init__(self, oaiwui_gpt: OAIWUI_GPT, enable_vision: bool = True, prompt_presets_dir: str = None, prompt_presets_file: str = None) -> None:
        ...
        self.use_max_completion_tokenss = oaiwui_gpt.get_use_max_completion_tokenss()
    ...
    def set_ui(self):
        ...
        with st.sidebar:
            ...
            if self.prompt_presets_settings == {}:
                ...
                if model_name in self.use_max_completion_tokenss and self.use_max_completion_tokenss[model_name] is True:
                ...
                if role_selector is True:
                    ...
                    for r in roles_toremove:
                        tmp_roles.pop(r)
                    tmp_txt = "" if use_max_completion_tokens is False else "\n\nBeta models do not support the 'system' role"
